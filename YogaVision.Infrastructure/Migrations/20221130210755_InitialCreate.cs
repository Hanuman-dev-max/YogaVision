        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrlFirst = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrlSecond = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrlThird = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagBlogPosts", x => new { x.TagId, x.BlogPostId });
                    table.ForeignKey(
                        name: "FK_TagBlogPosts_BlogPosts_BlogPostId",
                        column: x => x.BlogPostId,
                        principalTable: "BlogPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TagBlogPosts_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudioId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_YogaEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_YogaEvents_Instructors_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "Instructors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_YogaEvents_Studios_StudioId",
                        column: x => x.StudioId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagBlogPosts_BlogPostId",
                table: "TagBlogPosts",
                column: "BlogPostId");

            migrationBuilder.CreateIndex(
                name: "IX_TagBlogPosts_IsDeleted",
                table: "TagBlogPosts",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_YogaEvents_InstructorId",
                table: "YogaEvents",
                column: "InstructorId");

            migrationBuilder.CreateIndex(
                name: "IX_YogaEvents_IsDeleted",
                table: "YogaEvents",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_YogaEvents_StudioId",
                table: "YogaEvents",
                column: "StudioId");
        }
