namespace YogaVision.Core.Contracts
{
    ...
    public interface IInstructorService
    {
        ...
        /// <param name="facebookLink">Facebook link of the Instructor</param>
        /// <returns></returns>
        Task EditAsync(int id, string firstName, string lastName, string description, string nickName, string imageUrl, string imageUrlFirst, string imageUrlSecond, string imageUrlThird, string facebookLink);
